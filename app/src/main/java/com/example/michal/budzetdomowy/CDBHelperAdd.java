...
public class CDBHelperAdd extends  android.database.sqlite.SQLiteOpenHelper {
    ...
    private static final String DB_NAZWA =  "Material4.db";
    ...
    public CDBHelperAdd(Context ctx){
