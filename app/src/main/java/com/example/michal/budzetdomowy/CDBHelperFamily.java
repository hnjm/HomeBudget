...
public class CDBHelperFamily extends  android.database.sqlite.SQLiteOpenHelper {
    ...
    private static final String DB_NAZWA =  "Material2.db";
    ...
    public CDBHelperFamily(Context ctx){
