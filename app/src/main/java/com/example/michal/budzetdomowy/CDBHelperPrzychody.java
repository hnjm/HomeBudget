...
public class CDBHelperPrzychody extends  android.database.sqlite.SQLiteOpenHelper {
    ...
    private static final String DB_NAZWA =  "Material3.db";
    ...
    public CDBHelperPrzychody(Context ctx){
